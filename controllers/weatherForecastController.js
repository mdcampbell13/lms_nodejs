...
exports.viewWeatherForecastScreen = async function(req, res) {
        ...
        await fetch(`https://api.openweathermap.org/data/2.5/onecall?lat=${weatherZipInfo.lat}&lon=${weatherZipInfo.lng}&units=imperial&exclude=minutely,alert&appid=${process.env.OPENWEATHERAPIKEY}`)
        .then(res => res.json())
